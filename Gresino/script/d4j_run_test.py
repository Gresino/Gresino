...
def test_patched_project(patch_location: str, buggy_location: str, work_dir: str, test: str, buggy_project: str, class_file: str):
  ...
  try:
    if os.environ['GREYBOX_BRANCH']=='1':
      ...
      # if not os.path.exists(src_path+'/anonymous'):
      #   os.makedirs(src_path+'/anonymous')
      # if not os.path.exists(src_path+'/anonymous/apr'):
      #   os.makedirs(src_path+'/anonymous/apr')
      # if not os.path.exists(src_path+'/anonymous/apr/GlobalStates.java'):
      #   copyfile(f'{os.environ["GREYBOX_INSTR_ROOT"]}/src/main/resources/anonymous/apr/GlobalStates.java',src_path+'/anonymous/apr/GlobalStates.java')
